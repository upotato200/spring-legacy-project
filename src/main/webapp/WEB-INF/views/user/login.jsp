...
<style>
  ...
  .login-box-body { background: #fff; padding: 30px; border-radius: 4px; box-shadow: 0 2px 6px rgba(0,0,0,.15); }
  .login-logo { text-align: center; margin-bottom: 20px; }
  .login-logo a { color: #333; font-size: 26px; font-weight: bold; text-decoration: none; }
</style>
</head>
<body>
<div class="login-box">
